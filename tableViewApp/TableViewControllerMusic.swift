...
class TableViewControllerMusic: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "NewsCell3", for: indexPath)

        cell.textLabel?.text = news3[indexPath.row]
        cell.imageView?.image = UIImage(named: "onpu")
